package practice.standard.jun2017.problem1;
...
public class DoublyLinkedDeleteFirst {
	...
	public String deleteFirst() throws IllegalStateException {
		if(header.next == null || header.next.next == null) throw new IllegalStateException();
		Node tobeRemoved = header.next.next;
		String value = tobeRemoved.value;
		header.next.next = tobeRemoved.next;
		if(tobeRemoved.next != null)
			tobeRemoved.next.previous = header.next.next;
		tobeRemoved = null;
		return value;
	}
