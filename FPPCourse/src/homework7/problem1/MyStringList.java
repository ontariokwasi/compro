...
public class MyStringList {
	...
	public static void main(String[] args) {
		...
		/*
		 * l.add("Bob"); l.add("Steve"); l.add("Susan"); l.add("Mark"); l.add("Dave");
		...
		// ======================================//
		// use loop to add itemes to strArry
		String[] tempArr = { "big", "small", "tall", "short", "round", "square", "enormous", "tiny", "gargantuan",
		...
		System.out.println("Before sort: " + myStringList);
		myStringList.sort();
		System.out.println("After sort: " + myStringList);
		System.out.println("Find \"number\" "+myStringList.search("number"));
		System.out.println("Find \"tiny\" "+myStringList.search("tiny"));
	}
