...
//		S[] entries =
//			{new StudentSectionFactory.(bob,bio1,"A"), new StudentSectionFactory(bob,math,"B"), new StudentSectionFactory(tim,bio1,"B+"),
//			 new StudentSectionFactory(tim,math,"A-"), new StudentSectionFactory(allen,math,"B"), new StudentSectionFactory(allen,bio2,"B+")};
//		
